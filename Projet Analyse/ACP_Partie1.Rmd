...
il est clair qu’il existe des corrélations importantes entre des groupes de variables ce qui suggère la pertinence de cette ACP par exemple, on a Sport de Combat et Coaching Privé ,Bar et Resauration ect...
...
Critère de kaiser : on remarque qu’il y 5 axes dont les valeurs propres sont supérieures à 1 donc on retient 5 axes d’après ce critère.

Critère du taux d’inertie cumulée : On remarque que le taux d’inertie cumulé des 2 premiers axes est de 50.43% qui est un taux important compte tenu du fait que nous avons 15 variables.
...
pour le premier dimension , on peut mettre les variables : Cours.Privés,Bar , Coaching.Privé, Machines.de.cardio, Restauration dans un groupe homogene avec le nom d'"Premium"
Pour le deuxieme axe : on a Poids.libre, Appareils.à.musculation, Sport.de.combat, Garderie , donc un groupe homogene avec le nom "Standard"
